# Seedance 2.0 Mini API 日本語ガイド：モデル ID・秒単価・実行例
...
## APIMart 経由で Seedance 2.0 Mini を呼ぶ理由

- **1 つのキーで全カタログ。** 同じベース URL と認証ヘッダで Seedance 2.0 Mini を含む 300 以上の画像・動画・言語モデルに到達でき、切り替えは `model` フィールドのみ。
